...
jsPsych.plugins["pit-instructions"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
	...
	new_html += '<button id="jspsych-instructions-next" class="jspsych-btn" style="margin-left: 5px;">הבא</button>';
    new_html += '<button id="jspsych-instructions-back" class="jspsych-btn" style="margin-right: 5px;" disabled="disabled">הקודם</button>';
    new_html += '</div></div>';
